...
module.exports = [
    ...
    body('dni').notEmpty().withMessage('El campo no puede estar vacio').bail(),
    isNumeric().withMessage('No se permiten letras o caracteres especiales').bail(),

    body('provincia').notEmpty().withMessage('El campo no puede estar vacio').bail(),
    isAlpha().withMessage('No se permiten numeros o caracteres especiales').bail(),

    body('localidad').notEmpty().withMessage('El campo no puede estar vacio').bail(),
    isAlpha().withMessage('No se permiten numeros o caracteres especiales').bail(),

    body('calle').notEmpty().withMessage('El campo no puede estar vacio').bail(),
    isAlpha().withMessage('No se permiten numeros o caracteres especiales').bail(),

    body('altura').notEmpty().withMessage('El campo no puede estar vacio').bail(),
    isNumeric().withMessage('No se permiten letras o caracteres especiales').bail(),
